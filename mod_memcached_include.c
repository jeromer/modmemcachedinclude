...
#include "http_core.h"
#include "mod_memcached_include.h"
...
static APR_OPTIONAL_FN_TYPE(ap_register_memcached_include_handler) *ssi_pfn_register;
                                   ...
                                   apr_bucket_brigade *bb)
{
    ...
    while (1) {
         ...
         */
        if (rr) {
            ap_set_module_config(rr->request_config, &memcached_include_module, r);
        }
...
static apr_status_t includes_filter(ap_filter_t *f, apr_bucket_brigade *b)
{
    ...
    if ((parent = ap_get_module_config(r->request_config, &memcached_include_module))) {
...
static int include_fixup(request_rec *r)
{
    ...
    conf = ap_get_module_config(r->per_dir_config, &memcached_include_module);
                                         ...
                                         const char *tag)
{
    ...
    conf= ap_get_module_config(cmd->server->module_config , &memcached_include_module);
...
static void ap_register_memcached_include_handler(char *tag, include_handler_fn_t *func)
{
...
static void register_hooks(apr_pool_t *p)
{
    ...
    APR_REGISTER_OPTIONAL_FN(ap_register_memcached_include_handler);
